...
heavy_vehicles = [
    ["gm_ge_army_m113a1g_apc_win",200,50,100],                          // M113A3 (MG3)
    ["gm_ge_army_m113a1g_apc_milan_win",200,75,100],                    // M113A3 (MILAN)
    ["gm_ge_army_m113a1g_medic",200,0,100],                             // M113A3 (Medical)
    ["gm_dk_army_m113a2dk",200,90,100],
    ["gm_ge_army_fuchsa0_engineer_win",200,75,125],                     // Fuchs (Engineer)
    ["gm_ge_army_fuchsa0_reconnaissance_win",200,100,125],              // Fuchs (Recon, MILAN)
    ["gm_ge_army_luchsa1_oli",225,125,125],                              //SpPz 2A1   
    ["gm_ge_army_luchsa2_win",225,150,150],                                  //SpPz2A2
    ...
    ["gm_ge_army_Leopard1a5_win",575,575,275]                               // Leopard 1A3A5
];

air_vehicles = [
    ["gm_ge_army_bo105p1m_vbh_swooper",225,0,125],                       //VBH swooper     
    ["gm_ge_army_bo105p_pah1",225,150,125],                             //PAH1
    ["gm_ge_army_bo105p_pah1a1",250,175,125],                           //PAH1a1
    ["gm_ge_army_ch53gs",300,0,175],                                     //CH-53GS
    ["gm_ge_airforce_do28d2", 225, 0, 125]                              //Do 28 D2
   
];

static_vehicles = [
    ["gm_ge_army_milan_launcher_tripod",50,100,0],                       // Static MILAN
    ["gm_ge_army_mg3_aatripod",15,15,0],                                //MG3
    ["RHS_M252_WD",50,100,0]                                            //mortar
];
