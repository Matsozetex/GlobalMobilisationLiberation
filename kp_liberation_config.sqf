...
Useless if you're using anything other than "kp_liberation_arsenal = 4;" above. A whitelisted arsenal is always more performance friendly then a blacklisted arsenal.
...
KPLIB_transportConfigs = [
    ...
    ["gm_ge_army_ch53gs", -11.0, [0,7,-3.2], [0,7,-2.0], [0,5.5,-3.2], [0,5.5,-2.0], [0,4,-3.2], [0,4,-2.0], [0,2.5,-3.2], [0,2.5,-2.0], [0,1.0,-3.2], [0,1.0,-2.0], [0,-0.5,-3.2], [0,-0.5,-2.0]],
